    ...
    return (
        <div className="flex flex-col min-h-screen bg-background text-foreground">
            ...
            <div className="fixed bottom-6 right-6 flex flex-col gap-3 z-50">
              <a href="https://wa.me/5217771234567" target="_blank" rel="noopener noreferrer" aria-label="WhatsApp" className="bg-green-500 hover:bg-green-600 rounded-full shadow-lg p-3 transition-colors">
              ...
              <a href="https://instagram.com/tu_instagram" target="_blank" rel="noopener noreferrer" aria-label="Instagram" className="bg-gradient-to-tr from-pink-500 via-red-500 to-yellow-400 hover:from-pink-600 hover:to-yellow-500 rounded-full shadow-lg p-3 transition-colors">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-7 h-7 text-white">
