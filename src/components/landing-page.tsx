...
export default function LandingPage() {
    return (
        <div className="flex flex-col min-h-screen bg-background text-foreground">
            ...
            <Footer />
            {/* Botones flotantes de WhatsApp, Instagram y Facebook + chat */}
            <div className="fixed bottom-6 right-6 flex flex-col gap-3 z-50">
              ...
              <a href="https://www.facebook.com/profile.php?id=61558472693983" target="_blank" rel="noopener noreferrer" aria-label="Facebook" className="bg-blue-600 hover:bg-blue-700 rounded-full shadow-lg p-3 transition-colors">
