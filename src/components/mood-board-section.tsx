...
const moodImages = [
  { src: "/images/1.jpg", alt: "Bohemian style table setting", hint: "bohemian table" },
  { src: "/images/2.jpg", alt: "Minimalist floral centerpiece", hint: "minimalist floral" },
  { src: "/images/3.jpg", alt: "Vintage lighting fixtures", hint: "vintage lighting" },
  { src: "/images/4.jpg", alt: "Modern lounge area setup", hint: "modern lounge" },
  { src: "/images/1.jpg", alt: "Rustic outdoor ceremony arch", hint: "rustic arch" },
  { src: "/images/2.jpg", alt: "Elegant gold cutlery", hint: "gold cutlery" },
  { src: "/images/3.jpg", alt: "Pastel color balloon decorations", hint: "pastel balloons" },
  { src: "/images/4.jpg", alt: "Luxurious velvet seating", hint: "velvet seating" },
];
